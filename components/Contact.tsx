...
const Contact = () => {
  return (
    <section
      ...
      <section
        className={`${openSans.className} grid w-full grid-cols-2 gap-5`}>
        <div className='flex items-center gap-5 bg-white p-5'>
          ...
          <div className='flex items-center gap-5 bg-white p-5'>
            ...
            <p className='text-[#212529]'>
              Jl. Gunung Kerinci, No 10. Dasan Agung Baru, Selaparang, Mataram,
              NTB.
            </p>
          </div>
        </div>
        <div className='flex items-center gap-5 bg-white p-5'>
          ...
          <div>
            ...
            <p className='text-[#212529]'>robokarsa@gmail.com</p>
          </div>
        </div>
        <div className='flex items-center gap-5 bg-white p-5'>
          <figure className='rounded-full bg-[#2b77f2] p-5 text-white'>
